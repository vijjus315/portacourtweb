        ...
        if (modal) {
            const handleShow = () => {
                try {
                    ...
                    setProfilePreview(userData.profile ? `${window.location.origin}/storage/${userData.profile}` : `${window.location.origin}/dummy.png`);
                } catch (err) {
                                ...
                                <div className="position-relative">
                                    <div>
                                        <img 
                                            ...
                                            src={profilePreview || `${window.location.origin}/dummy.png`}
                                            alt="Profile Preview"
                                        />
                                    </div>
