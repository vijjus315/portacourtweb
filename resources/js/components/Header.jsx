                        ...
                        <div className="d-flex gap-4 align-items-center flex-wrap">
                            ...
                            {!isLoggedIn ? (
                                ...
                                <div className="dropdown">
                                    <a className="d-flex align-items-center profile-main gap-2 dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img src={userData?.profile || `${window.location.origin}/dummy.png`} className="img-fluid user-profile" alt="Profile" />
                                        <p className="profile-name text-white mb-0 fw-400">{userData?.name || 'User'}</p>
                                    </a>
                                    <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a className="black-grey" href="#">
                                        ...
                                        <ul className="ps-0 list-style-none">
                                            <li>
                                                <a className="dropdown-item text-grey font-Yantramanav fw-400 py-2 d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#editprofile">
                                            ...
                                            <li>
                                                <a className="dropdown-item text-grey font-Yantramanav fw-400 py-2 d-flex align-items-center gap-2 me-2" href="/my-orders">
                                            ...
                                            <li>
                                                <a className="dropdown-item text-grey font-Yantramanav fw-400 py-2 d-flex align-items-center gap-2" href="/my-address">
                                        ...
                                        <a className="w-100 d-block text-center primary-theme text-decoration-underline mb-2 mt-2 text-capitalize" data-bs-toggle="modal" data-bs-target="#changepwd">Change Password</a>
                                    </div>
                                </div>
                            )}
                        </div>
