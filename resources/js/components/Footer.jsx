            ...
            <div className="container">
                <div className="row ">
                    ...
                    <div className="col-md-6  col-lg-2 mb-3 mb-lg-0">
                        <h5 className="primary-theme">Service</h5>
                    ...
                    <div className="col-md-6  col-lg-3 mb-3 mb-lg-0">
                        <h5 className="primary-theme">Get In Touch</h5>
                        <ul className="footer-list ps-0 pt-2">
                    ...
                    <div className="col-md-6  col-lg-3 mb-3 mb-lg-0">
                        <h5 className="primary-theme">Quick Links</h5>
                        <ul className=" footer-list ps-0 pt-2">
                ...
                <div className="row">
                    <div className="col-md-6 col-xl-4 mb-3 mb-lg-0">
                        <div className="logo-footer">
                            <h5 className="primary-theme">Newsletter</h5>
                    ...
                    <div className="col-md-6  col-xl-3 mb-3 mb-lg-0">
                        <h5 className="primary-theme ">Follow Us On</h5>
