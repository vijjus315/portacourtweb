...
import { getAddresses, addAddress, deleteAddress } from '../api/address.js';
import '../bootstrap';
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-6">
                            ...
                            <h2 className="text-capitalize">My Address</h2>
                        </div>
                        <div className="col-6 text-end">
                            <button type="button" className="btn green-btn" data-bs-toggle="modal" data-bs-target="#addaddress">Add address</button>
                        </div>
                    </div>
                                    ...
                                    <div className="address-inner bg-white p-3 br15 d-flex justify-content-between">
                                        ...
                                        <div className="d-flex flex-column justify-content-between align-items-end">
                                            <div className="dropdown drop-address">
                                                <button className="btn dropdown-toggle" type="button" id={`dropdownMenuButton${address.id}`} data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <div className="">
                                                <a className="primary-theme light light-green border-0 d-inline-block rounded-pill px-3 py-1 d-flex align-items-center gap-1" href="javascript:void(0);">
                                                    <img src="/webassets/img/home-icon.svg" alt="Home" />
                                                    Home
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div className="modal-content modal-content-width">
                        <div className="modal-body pt-0">
                            <div className="d-flex align-items-center justify-content-between gap-2 pb-2">
                                <h1 className="font-oswald mb-0">Add Address</h1>
