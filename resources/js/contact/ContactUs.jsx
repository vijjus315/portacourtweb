                ...
                <div className="row">
                    <div className="col-lg-4 px-0">
                        <div className="product-inner white-green position-relative">
                            ...
                            <h4 className="text-uppercase fw-600">Visit Us</h4>
                    ...
                    <div className="col-lg-4 px-0">
                        <div className="product-inner green-white position-relative">
                            ...
                            <h4 className="text-uppercase fw-600">Call us</h4>
                    ...
                    <div className="col-lg-4 px-0">
                        <div className="product-inner black-green position-relative">
                            ...
                            <h4 className="text-uppercase fw-600">Contact Us</h4>
                            ...
                            <div className="row">
                                <div className="col-lg-6 mb-5">
                                    <div className="form-group">
                                        ...
                                        />
                                        <span className="text-danger error-message" id="error-first_name"></span>
                                    </div>
                                </div>
                                <div className="col-lg-6 mb-5">
                                    <div className="form-group">
        ...
        <div className="stay-blog">
          ...
          <div className="stay-blog-details bg-white">
            <div className="inner-blog-detail">
              ...
              <h4 className="one-line textcolor">
