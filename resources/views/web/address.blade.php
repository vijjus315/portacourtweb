    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-6">
                ...
                <h2 class="text-capitalize">My Address</h2>
            </div>
            <div class="col-6 text-end">
                <button type="button" class="btn green-btn" data-bs-toggle="modal" data-bs-target="#addaddress">Add address</button>
                <!-- <a href="" class="green-btn">Add Address</a> -->
            </div>
        </div>
        <div class="row pt-4">
            @foreach($address as $singleaddress)
            <div class="col-md-4 mb-3">
                <div class="address-inner bg-white p-3 br15 d-flex justify-content-between">
                    <div class="">
                        <div class="addres-detail">
                            <h6 class="fw-600 primary-theme">{{$singleaddress->first_name}} {{$singleaddress->last_name}}</h6>
                        </div>
                        <div class="address-drop">
                            <p class="text-grey mb-0 fw-400">{{$singleaddress->street_address}}, {{$singleaddress->city}}, {{$singleaddress->county}}</p>
                            <p class="text-grey mb-0 fw-400">Mobile No. {{$singleaddress->phone}}</p>
                            <p class="text-grey mb-0 fw-400">Pin Code: {{$singleaddress->postcode}}</p>
                        </div>
                    </div>
                    <div class="d-flex flex-column justify-content-between align-items-end">
                        <div class="dropdown drop-address">
                            <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{url('/')}}/webassets/img/hori-dots.svg">
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <!-- <li><a class="dropdown-item" href="#">Edit</a></li> -->
                                <li><a class="dropdown-item" href="{{route('removedAddress',$singleaddress->id)}}" onclick="return confirm('Are you sure you want to delete this address?');">Delete</a></li>
                            </ul>
                        </div>
                        <div class="">
                            <a class="primary-theme light light-green border-0 d-inline-block rounded-pill px-3 py-1 d-flex align-items-center gap-1" href="javascript:void(0);"><img src="{{url('/')}}/webassets/img/home-icon.svg">Home</a>
                        </div>
                        <!-- <div class="">
                            @if($singleaddress == 'home')
                            <a class="primary-theme light light-green border-0 d-inline-block rounded-pill px-3 py-1 d-flex align-items-center gap-1"><img src="{{url('/')}}/webassets/img/home-icon.svg">Home</a>
                            @elseif($singleaddress == 'hotel')
                            <a class="primary-theme light light-green border-0 d-inline-block rounded-pill px-3 py-1 d-flex align-items-center gap-1"><img src="{{url('/')}}/webassets/img/hotel-icon.svg">Hotel</a>
                            @elseif($singleaddress == 'work')
                            <a class="primary-theme light light-green border-0 d-inline-block rounded-pill px-3 py-1 d-flex align-items-center gap-1"><img src="{{url('/')}}/webassets/img/building-icon.svg">Work</a>
                            @else
                            <a class="primary-theme light light-green border-0 d-inline-block rounded-pill px-3 py-1 d-flex align-items-center gap-1"><img src="{{url('/')}}/webassets/img/location-icon.svg">{{$singleaddress->address_type}}</a>
                            @endif
                        </div> -->
                    </div>
                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="15" viewBox="0 0 12 15" fill="none">
                                        ...
                                        <!-- <img src="{{url('/')}}/webassets/img/location-color.svg" class="color-icon">
                                        <img src="{{url('/')}}/webassets/img/location-grey.svg" class="grey-icon">  -->
                                        Other
                                    </a>
                                </div>
