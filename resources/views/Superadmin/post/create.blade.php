                                    ...
                                    <div class="card card-primary card-outline p-3">
                                        <form class="form-horizontal" action="{{route('post.store')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control" placeholder="Enter author" required type="text" name="author" value="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputName" class="col-sm-12 control-label">Meta Title</label>
                                                <div class="col-sm-12">
                                                    <input class="form-control" placeholder="Enter title" required type="text" name="meta_title" value="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputName" class="col-sm-12 control-label">Meta Description</label>
                                                <div class="col-sm-12">
                                                    <input class="form-control" placeholder="Enter description" required type="text" name="meta_description" value="">
                                                </div>
                                            </div>
                                            <!-- <div class="form-group">
                                                <label for="inputName" class="col-sm-12 control-label">Quote</label>
                                                <div class="col-sm-12">
                                                    <textarea class="summernote" required type="text" name="quote"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputName" class="col-sm-12 control-label">Summary</label>
                                                <div class="col-sm-12">
                                                    <textarea class="summernote" required type="text" name="summary"></textarea>
                                                </div>
                                            </div> -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control" required type="text" name="schema"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
