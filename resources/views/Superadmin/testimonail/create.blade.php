                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary card-outline p-3">
                                        <form class="form-horizontal" action="{{route('testimonail.store')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control" placeholder="Enter designation" required type="text" name="designation" value="">
                                                </div>
                                            </div>
                                            <div class="form-group">
