                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="form-horizontal" action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control" placeholder="Enter title" required type="text" name="title" value="{{$category->title}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputName" class="col-sm-12 control-label">Sort Description</label>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control" required  name="sort_description" >{{$category->sort_description}}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
