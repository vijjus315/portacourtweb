                                        ...
                                        <form class="form-horizontal" action="{{route('product.update', $product)}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" name="cat_id" required>
                                                    ...
                                                    <option value="{{$singlecat->id}}" {{ $singlecat->id == $product->cat_id ? 'selected' : '' }}>{{$singlecat->title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control" placeholder="Enter title" required type="text" name="title" value="{{ $product->title }}">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" placeholder="Enter length" required type="text" name="length[]" value="{{$varient->length}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" placeholder="Enter width" required type="text" name="width[]" value="{{$varient->width}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" placeholder="Enter thickness" required type="text" name="thickness[]" value="{{$varient->thickness}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" placeholder="Enter price" required type="text" name="price[]" value="{{$varient->price}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" placeholder="Enter discount" required type="text" name="discount[]" value="{{$varient->discount}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" placeholder="Enter quantity" required type="text" name="quantity[]" value="{{$varient->quantity}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="cross-icon">
                                                        <a href="{{route('removedvariant',$varient->id)}}" onclick="return confirm('Are you sure you want to remove this attribute?');"><i class="fa fa-times-circle-o removevarient" aria-hidden="true"></i></a>
                                                    </div>
                                                </div>
                                                @endforeach
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="summernote" required type="text" name="description">{{ $product->description }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input  type="checkbox" name="is_featured" value="1" {{ $product->is_featured ? 'checked' : '' }}> Yes
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <button type="submit" class="btn btn-primary btnsign_green toastrDefaultSuccess">Update Product</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
